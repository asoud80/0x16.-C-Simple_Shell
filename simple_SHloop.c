...
/**
 * shsh - this is the Main Shell Loop
 *
...
/**
 * found_bltin - for Finding bltin Command.
 *
...
/**
 * found_cmd - to Find Command In the PATH
 *
 * @info: Parameter and Return Info Struct
 * Return: void
 */

void found_cmd(info_t *info)
{
        int a, b;
        char *path = NULL;
...
/**
 * frk_cmd - it will Forks and execuate Thread for running cmd.
 *
 * @info: Parameter and Return Info Struct
 * Return: void
 */
